...
<div class="container">
	...
	<ul class="nav navbar-nav">
		...
		<li><a href="uploadData.jsp">
				UploadDocuments </a></li>
		<li><a href="addQuestion.jsp">AddQuestion</a></li>
		<li class="active"><a href="editProfile.jsp"> UpdateDetails
		</a></li>
...
<div class="row">
<div class="col-sm-3">
<form action="updateF" class="form-group" style="margin-left: 10px" method="post">
Subject<br>
